...
import {Icon, Rate, Button, Tabbar, TabbarItem, Search, Swipe, SwipeItem, Lazyload, Col, Row, List, Cell, Tag} from 'vant'

Vue.config.productionTip = false;

/* eslint-disable no-new */
Vue.use(Button).use(Tabbar).use(TabbarItem).use(Search).use(Swipe).use(SwipeItem);
Vue.use(Lazyload).use(Col).use(Row).use(List).use(Cell).use(Tag).use(Rate).use(Icon);
